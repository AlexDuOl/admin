...
export const extraerOpcionesClientes =
  cliente => { return { key: cliente.id, text: cliente.nombreEmpresa, value: cliente.id } };

export const extraerOpcionesRutas =
  ruta => { return { key: ruta.id, text: ruta.nombre, value: ruta.id } };

export const extraerOpcionesEstructuras =
  estructura => { return { key: estructura.id, text: estructura.detalle(), value: estructura.id } };
